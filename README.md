...
3. 拡張のジグゾーパズルのとこ押すとポップアップで現れます。
<img width="973" alt="スクリーンショット 2021-10-21 23 06 49" src="https://user-images.githubusercontent.com/43945931/138294827-03a34255-c064-4967-92aa-df68b9fc5b72.png">
## Shortcut
`Alt+U`（Macなら`Option+U`）で呼び出します。
自動翻訳がある動画で、
1. 文字起こしを開く→コピペで
2. コピーした瞬間に終わります。
